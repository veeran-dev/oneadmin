...
export default function Settings() {
  const { user } = useUser();
  const [registerInstituteMutation, { loading, error }] =
  ...
  const [addUserMutation, { loading: addUserLoading, error: addUserError }] =
  ...
  const refetchUserQuery = async (instituteId: any, mobile: any) => {
    try {
      ...
      const addUserResponse = await addUserMutation({
        variables: { createStaff: userData }, // Replace with the appropriate variables
      });
      console.log("addUserResponse...", addUserResponse);
      if (addUserResponse && force === "true") {
        setSuccess(true);
        setSuccessMessage(
          "Your account created successfully, you will redirected to dashboard"
        );
        setTimeout(() => {
  ...
  return (
    <div className="px-8 py-4">
      ...
      {user?.instituteId === undefined && (
        <Alert
          type="danger"
          message="Please complete this profile to create your account"
        />
      )}
        ...
        <form onSubmit={handleSubmit(handleRegistration, handleError)}>
          <div className="space-y-12">
            ...
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <p className="mt-1 text-sm leading-6 text-gray-600">
                Will be used to contact and shown on the website
              </p>
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div className="col-span-full">
                  <label
                    ...
                    className="block text-sm font-medium leading-6 text-gray-900"
                  >
                    {"Institute's Address (Main Branch)"}{" "}
                    <span className="text-red-600">*</span>
                  </label>
                  <div className="mt-2">
                    <input
