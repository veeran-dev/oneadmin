...
export default function RecentTransaction(){
    ...
    const { loading:getLoading, error:getError, data:history } =  usePayment(defaultPagination, name)
    ...
    return(
        <div className='mt-8'>
            <div className="flex flex-row justify-between">
                ...
                <Link className="text-xs font-semibold text-gray-600" href={"/payments"}>View All</Link>
            </div>
